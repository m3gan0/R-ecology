...
the weights from our datasets, we can use: `surveys$weight`. You can use
...
the square brackets: `surveys[, c("weight", "sex")]`.

**Stop here, we'll go over subsetting with dplyr**
